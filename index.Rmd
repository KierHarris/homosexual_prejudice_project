...
# use geom_bar to create a bar chart, dodge to seperate males and females by the condition they were in to create a grouped bar chart and mean to ensure the mean prejudice scores are included
